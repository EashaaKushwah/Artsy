...
<link rel="stylesheet" href="CSS/Signup_body.css">
</head>
...
<body>
    ...
    <div class="jumbotron container alert-success">
        ...
        <p class="lead">We at team Artistify thank you for regestering with us and we promise to find your content the audience it deserves.</p>
        <hr class="my-4">
